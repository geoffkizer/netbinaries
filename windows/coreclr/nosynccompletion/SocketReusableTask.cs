    ...
    public class Program
    {
        ...
        class Connection
        {
            ...
            public Connection()
            {
                ...
                SocketReusableTaskExtensions.SetupCallback(_acceptEventArgs);

                _readEventArgs = new SocketAsyncEventArgs();
                _readEventArgs.SetBuffer(new byte[4096], 0, 4096);
                SocketReusableTaskExtensions.SetupCallback(_readEventArgs);

                _writeEventArgs = new SocketAsyncEventArgs();
                _writeEventArgs.SetBuffer(s_responseMessage, 0, s_responseMessage.Length);
                SocketReusableTaskExtensions.SetupCallback(_writeEventArgs);
            }
